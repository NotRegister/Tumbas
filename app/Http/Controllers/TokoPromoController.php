...
class TokoPromoController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('toko.promo.index', $data)->with('no', ($request->input('page', 1) - 1) * 20);
    }
    ...
    public function create()
    {
        ...
        return view('toko.promo.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($cekpromo) {
            ...
            return redirect()->route('tokopromo.index')->with('success', 'Data berhasil disimpan');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('toko.promo.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($cekpromo) {
            ...
            return redirect()->route('tokopromo.index')->with('success', 'Data berhasil diupdate');
        }
    }
