            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('toko.index') }}" class="btn btn-sm btn-danger">
                            Tutup
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('toko.update', $itemproduk->id) }}" method="post">
                        {{ method_field('patch') }}
                        @csrf
                        <div class="form-group">
                            ...
                            <select name="kategori_id" id="kategori_id" class="form-control">
                                ...
                                <option value="{{ $kategori->id }}" {{ $itemproduk->kategori_id == $kategori->id ? 'selected' : '' }}>
