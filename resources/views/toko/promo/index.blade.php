            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('tokopromo.create') }}" class="btn btn-sm btn-primary">
                            tambah
                        </a>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('tokopromo.edit', $promo->id) }}" class="btn btn-sm btn-primary mr-2 mb-2">
                                            Edit
                                        </a>
                                        <form action="{{ route('tokopromo.destroy', $promo->id) }}" method="post" style="display:inline;">
                                            @csrf
                                            {{ method_field('delete') }}
